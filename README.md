...
**Order:** 
[Files to Prepare](#files-to-prepare) | [Installing Virtual Box](#installing-virtual-box) | [Domain Controller VM Configuration](#domain-controller-vm-configuration) | [Microsoft Server OS Setup](#microsoft-server-os-setup) | [Installing VM guest Addition](#installing-vm-guest-addition) | [Assigning IP address to the internal network](#assigning-ip-address-to-the-internal-network) | [Installing ADDS (Active Directory Domain Service)](#installing-adds-(active-directory-domain-service)) | [Creating a Domain](#h) | [Creating a Domain Admin User Account](#i) | [Installing RAS/NAT](#j) | [DHCP Server Setup](#k) | [DHCP Scope Setup](#l) | [Exclusion, Lease Duration, and DHCP options](#m) | [Automation: using PowerShell script to create 1000+ users](#n) | [PowerShell Script Code Breakdown](#o) | [Running the PowerShell Script](#p) | [Client Window 10 VM configuration](#q) | [Client OS setup](#r) | [Network Status Check](#s) | [Changing the hostname and Joining the domain group](#t) | [Final Check: DHCP Control Panel & ADUC](#u) | [V](#v) | [W](#w) | [Y](#y) | [Z](#z)
